...
public class AlwaysOnTop : MonoBehaviour {
    ...
    public static string CONSTANT_WINDOW_TITLE_FROM_GAME = "timetimer";
    ...
    const System.UInt32 WS_EX_TOPMOST = 0x0008;
    ...
    public void SetAlwaysTop(bool isAlwaysTop){
        AssignTopmostWindow(CONSTANT_WINDOW_TITLE_FROM_GAME, isAlwaysTop);
    }
